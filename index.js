...
client.on('guildMemberAdd', async member => {
    ...
    switch (broj) {
        case 1:
            slika = './images/img1.jpg';
            break;
        case 2:
            slika = './images/img2.jpg';
            break;
        case 3:
            slika = './images/img3.jpg';
            break;
        case 4:
            slika = './images/img4.jpg';
            break;
        case 5:
            slika = './images/img5.jpg';
            break;
        case 6:
            slika = './images/img6.jpg';
            break;
    }
        ...
        if (message.member.roles.cache.some(r => ["Admin"].includes(r.name))) {
            const pomocEmbed = new Discord.MessageEmbed()
                ...
                .addFields({
                    ...
                    name: 'rules',
                    value: 'show you the rules on server'
                }, {
                    name: 'ping',
                    value: 'gets your ping'
                }, {
                    name: 'server',
                    value: 'about server'
                }, {
                    ...
                    name: 'help',
                    value: 'all commands you can use'
                }, )
                .setTimestamp()
                .setFooter('JaKiMa BOT', 'https://i.imgur.com/0Ty2pLI.jpg');
